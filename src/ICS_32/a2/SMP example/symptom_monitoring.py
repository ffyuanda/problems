...
# Code Example
#
# This module provides functions that implement the UCI Symptom Monitoring Protocol. The UCI Symptom Monitoring Protocol is an example protocol developed for ICS_32, but inspired by the UCI Working Well Daily Symptom Check email. This module is designed to be used by both Symptom Monitoring client and server programs.
# 
